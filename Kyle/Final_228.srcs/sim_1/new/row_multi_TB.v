...
module row_multi_TB;
    ...
    reg [(BIT_WIDTH*4)-1:0] tb_A,tb_B;
    wire [(BIT_WIDTH)-1:0] tb_C;
    wire tb_OF;
    ...
    begin
        ...
        $display("[A][B][C]: [%d %d %d %d] [%d %d %d %d] [%d]",
            tb_A[BIT_WIDTH*4-1:BIT_WIDTH*3], 
            tb_A[BIT_WIDTH*3-1:BIT_WIDTH*2], 
            tb_A[BIT_WIDTH*2-1:BIT_WIDTH], 
            tb_A[BIT_WIDTH-1:0],
            tb_B[BIT_WIDTH*4-1:BIT_WIDTH*3], 
            tb_B[BIT_WIDTH*3-1:BIT_WIDTH*2], 
            tb_B[BIT_WIDTH*2-1:BIT_WIDTH], 
            tb_B[BIT_WIDTH-1:0], tb_C);
        #5;
